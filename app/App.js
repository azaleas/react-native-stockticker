...
import IndiaContainer from './containers/IndiaContainer';
...
class App extends Component {
	navigatorRenderScene(route, navigator) {
        ...
        switch (route.id) {
          ...
          case 'cpr':
            return (<ClosingPricesReport navigator={navigator} dataSet={route.dataSet} data={route.data} title={route.title} />);
          case 'vr':
            return (<VolumesReport navigator={navigator} data={route.data} dataSet={route.dataSet} title={route.title} />);  
          case 'eu':
          ...
          case 'in':
            return (<IndiaContainer navigator={navigator} title={route.title} />);
        }
    }
